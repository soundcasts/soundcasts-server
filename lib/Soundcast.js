...
schema.methods.toXml = function() {
  var data = {
    ...
    channel: {
      ...
      link: this.link,
      description: `This is a custom podcast featuring the music of ${this.author} created using Soundcasts: https://soundcasts.net.\nShort url: https://soundcasts.net/${this.id}`,
      'itunes:image': {
        '@': {
          href: this.image
        }
